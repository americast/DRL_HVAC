...
class CustomEnvCombo(gym.Env):
    ...
    def step(self, action, i_mat, infer = False):
        weather_here = []
        ...
        # print("Here")
        self.eng.start3_combo(float(self.state[3]), i_mat, int(infer), nargout = 0, stdout=io.StringIO())

        self.power_consumption = scipy.io.loadmat("data/Power_data_combo.mat")["power_data"]
        # shape of each mat is 1 x 6

        self.temp_diff = scipy.io.loadmat("data/Temp_Diff_Desire_combo.mat")["temp_diff_data"]
